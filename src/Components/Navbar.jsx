  ...
  return (
    <>
      <Div>
        ...
        <p style={{ marginLeft: "10%" ,  fontSize:"25px" }}>
          <img
            style={{ marginLeft: "15%", width: '40px', height: '40px' , marginTop:"3%" }}
        ...
        <p style={{ marginLeft: "2%", fontSize:"25px" }}>
          <img
            style={{ marginLeft: "25%", width: '40px', height: '40px' , marginTop:"3%"}}
        ...
        <Link
          style={{marginLeft: "2%",fontSize: "40px",textDecoration: "none",color: "#282C3F", marginTop: "1.8%" }}
          to="/cart/:id"
        >
          {" "}
          <p>
          <a href="https://ibb.co/bsQg097">
          <img 
            src="https://i.ibb.co/VgJW143/Basanti.png" 
            alt="Basanti" 
