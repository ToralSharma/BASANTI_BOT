...
//   const pearScore = Math.max(0, (hip - chest - 7)) + Math.max(0, (2 - Math.abs(chest - waist)));
//   const hourglassScore = Math.max(0, (2 - Math.abs(chest - hip))) + Math.max(0, (chest - waist - 7));
//   const invertedTriangleScore = Math.max(0, (chest - hip - 4)) + Math.max(0, (2 - Math.abs(hip - waist)));

//   const totalScore = pearScore + hourglassScore + invertedTriangleScore;

//   if (totalScore > 0) {
//     bodyType.pear = (pearScore / totalScore) * 100;
//     bodyType.hourglass = (hourglassScore / totalScore) * 100;
//     bodyType.invertedTriangle = (invertedTriangleScore / totalScore) * 100;
//   }
...
//             <div className="fill hourglass" style={{ width: `${bodyType.hourglass}%` }}></div>
//           </div>
//           <p>{bodyType.hourglass.toFixed(2)}%</p>
//         </div>
//         <div className="result">
//           <h2>Inverted Triangle</h2>
//           <div className="progress-bar">
//             <div className="fill inverted-triangle" style={{ width: `${bodyType.invertedTriangle}%` }}></div>
//           </div>
//           <p>{bodyType.invertedTriangle.toFixed(2)}%</p>
//         </div>
//       </div>
//       <div className="recommendations">
//         <h2>Recommendations</h2>
