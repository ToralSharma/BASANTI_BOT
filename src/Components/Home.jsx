...
//           <h2>Know Your Aesthetic</h2>
//           <p>Take our quick quiz to find out your unique style.</p>
//         </div>
//         <div className="aesthetic-options">
//           <button className="aesthetic-option">Take the Quiz</button>
//           <button className="aesthetic-option">Learn More</button>
//         </div>
//         <div className="products-section">
//           {/* Assuming this section remains unchanged */}
